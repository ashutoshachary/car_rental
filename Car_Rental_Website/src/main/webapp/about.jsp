              ...
              <div class="row">
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <span>Car Book.com</span>
                    <h2>Get to know about <em>our company</em></h2>
                    <p>At CarBook.com everything we do is about giving you the freedom to discover more.We will move mountains to find you the right rental car, and bring you a smooth, hassle-free experience from start to finish. Here you can find out more about how we work. 
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-content">
              <span>About Us</span>
              <h2>IWT LAB  <em>Project</em></h2>
              <p>Project For IWT LAB<br> SILICON INSTITUTE OF TECHNOLOGY, (CS PUR,PATIA)</p>
            </div>
          </div>
          <div class="col-md-6 align-self-center">
            <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 footer-item">
            <h4> CarRent.com</h4>
            <p>With flexible rental options and a wide network that's visible across most cities in India, renting from carRent.com has become the preferred choice for most BBSR NCR locals.</p>
    ...
    <div class="sub-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p>
                Copyright © 2022<br> Pritam Nanda / Ashutosh Acharya 
            </p>
          </div>
        </div>
      </div>
