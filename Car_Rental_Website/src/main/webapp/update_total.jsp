...
<%
	try{
		...
		String id = request.getParameter("carId2");
		String numbers = request.getParameter("totalCars2");
		if(id != null){
		PreparedStatement statement = conn.prepareStatement("update car_inventory set  total_cars = ? where car_id = ?");
