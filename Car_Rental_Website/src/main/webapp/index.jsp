        ...
        <div class="Modern-Slider">
          ...
          <div class="item item-1">
            <div class="img-fill">
                <div class="text-content">
                  <h6>SELF DRIVE CARS IN BBSR</h6>
                  <h4>CAR ON RENT  <br> IN BBSR</h4>
          ...
          <div class="item item-2">
            <div class="img-fill">
                <div class="text-content">
                  <h6>SELF DRIVE CARS IN BBSR</h6>
                  <h4>now Available On <br>  BBSR</h4>
                  <p>In addition to being the capital city, BBSR is a cosmopolitan city with people from all over the country, and ready to embrace an evolving lifestyle</p>
                  <a href="fleet.jsp#car_serv" class="filled-button">Book Now</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="item item-3">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <a href="fleet.jsp#car_serv" class="filled-button">fleet</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="row">
            ...
            <div class="col-md-6 align-self-center">
              <div class="right-content">
                ...
                <p>We Are Student Pursing B.Tech From Silicon Institute of Technology , BBSR </p>
